public class AlertPresentationController: UIPresentationController, KeyboardObserver {
    ...
    override public var frameOfPresentedViewInContainerView: CGRect {
        ...
        let preferredContentWidth = presentedViewController.preferredContentSize.width
        return CGRect(x: (containerBounds.width - preferredContentWidth) / 2,
                      y: (containerBounds.height - preferredContentHeight) / 2,
